#!/usr/bin/python3
"""
This module implements `base` class of all other classes in the project.
The goal is to manage ID attribute in all future classes and to avoid
duplicating the same code/bugs
"""
...
class Base:
    ...
    @classmethod
    def draw(cls, list_rectagles, list_squares):
        """
        draw the figure
        """
